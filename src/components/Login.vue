  ...
  <div class="signup">
    ...
    <div class="signup-container">
      ...
      <div class="signup-buttons-container">
        <a class="signup-google signup-button" @click ="GoogleSignIn">
        ...
        <a class="signup-facebook signup-button" @click ="FacebookSignIn">
        ...
        <a class="signup-apple signup-button" @click="TwitterSignIn">
      ...
      <div class="clear"></div>
      <div class="signup-text">구글, 페이스북, 트위터로 로그인을 클릭하면
      ...
      <div id="frmSigninContainer">
        <div class="signup-text noPadding">
          <div class="bold alignTextCenter">이메일 계정으로 로그인</div>
          <div class="clear"></div>
        ...
        <div class="signup-text noPadding" style="display:none">
          <div class="right">
            <a id="fr24_ForgotPassword" class="forgot" href="관리자 문의">비밀번호 분실</a>
          </div>
          <div class="clear"></div>
        </div>
        <div class="signup-text btn-text">
          <input @click="login" class="signup-button signup-login" id="logIn" type="submit" value="로그인">
        </div>
        <input id="redirect" type="hidden" value=""> <input id="subscriptionId" type="hidden" value="">
      </div>
      <div class="clear"></div>
      <div id="btnSignupContainer">
        <router-link to="signUp" id="btnSignup">회원가입</router-link>
      </div>
    </div>
    <div class="clear"></div>
  </div>
